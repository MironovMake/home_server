...
// RGB control
let ReaderFromLocalStorage = localStorage.getItem('RGB')
document.getElementById("rgb").value = ReaderFromLocalStorage;

function updateRGB() {
  var hex = document.getElementById("rgb").value;
  document.getElementById("rgb").innerHTML = hex;
  console.log(hex);
  localStorage.setItem('RGB', hex);
...
ReaderFromLocalStorage = localStorage.getItem('window')
document.getElementById("SLIDER").value = ReaderFromLocalStorage;
...
function updateslider() {
  ...
  localStorage.setItem('window', sliderValue);
  console.log(sliderValue)

  // localStorage.clear();
  // sace date to local storage
}