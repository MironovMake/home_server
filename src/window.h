...
public:
    ...
    void WindowOpen()
    {
        ...
        delay(500);
*/
        //?FirstTimeFlag = 0; //! возможно надо будет убрать
        if (windowCurrentPositiopn != windowNewPositiopn && windowNewPositiopn != 0 && !FirstTimeFlag)
        {
            Serial.println();
            Serial.println("WindowOpen  12");
